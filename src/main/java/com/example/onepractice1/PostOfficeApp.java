...
public class PostOfficeApp {
    ...
    public static void execute(){
        ...
        Address address2 = new Address(2L,"KZ","CIT","Baitursinova",12,21);

        Client client1 = new Client(1L,"Nurila","Zharkynbek","n@gmail.com",address1);

        clientService.saveClient(client1);

        Post post1 = new Post(1L, "Description", "SENT",client1);
        Post post2 = new Post(2L, "Description", "DELIVERED",client1);
